...
<body class="bg-gray-800">
  ...
  <div class="mx-auto bg-cyan-500 max-w-7xl px-6 lg:px-8">
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div class="lg:pt-4 lg:pr-8">
        <div class="lg:max-w-lg">
          
          
          <h2 class="mt-2 text-4xl font-semibold tracking-tight text-pretty sm:text-5xl text-gray-950">CERTIFICACIÓN</h2>
          <img width="662.35" height="578.19" src="https://ec1191.my.canva.site/_assets/media/96de5a81462e99c985893cde78bb4d53.jpg" alt="Product screenshot" class="w-3xl max-w-none rounded-xl shadow-xl ring-1 ring-white/10 sm:w-228 md:-ml-4 lg:-ml-0" />
