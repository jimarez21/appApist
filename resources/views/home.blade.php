...
<body class="bg-gray-800">
    ...
    <div class="bienvenida">
        <div class="bienvenida-box">
            <img src="" alt="">
            <h2>BIENVENIDA/O AL MANUL DE PARTICIPANTE</h2>
            <p>Este manual ha sido diseñado como parte de la capacitación en el estandar EC1191 "Uso de las normas ortograficas en textos impresos/digitales (nivel intermedio)", avalado por el CONOCER.</p>
            <p>Su objetivo principal es fortalecer tus habilidades en la aplacación correcta de las reglas ortografíacas, permitiendote producir textos claros, precisos y profesionales en cualquier ámbito labpral o académico.</p>
            <hr>
            <p>La orotografía no es solo una cuestión de corrección, sino también de credibilidad y comunicación efectiva. Un texto bien escrito refleja atención al detalle y respeto por el lector. A través de este manual,trabajarás en los aspectos más desafiantes de la ortografía del español, desde e uso adecuado de letras y tildes hasta la escritura de las palabras homófonas y la aplicación de mayúculas.</p>
            <hr>
        </div>
        <div class="bienvenida box">
            <h2>"ESTRUCTURA DEL MANUAL".</h2>
